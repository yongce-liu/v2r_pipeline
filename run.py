...
05: composite (depth-aware compositing -> final robot operation video frames)
    composite/.venv/bin/python -m composite.cli --inpainted-json outputs/0/inpaint/inpainted.json --depth-json outputs/0/depth/depth.json --calibration-depth-json outputs/0/depth_orig/depth.json --masks-json outputs/0/segment/masks.json --camera-json outputs/0/retarget/camera.json --video
